...
checkpoint_file = '/home/justsomeone/code/seg/project/cloth_parsing/test/iter_64000.pth'
...
# test a single image
img_list = get_file_recursively(r'/home/justsomeone/data/seg/dresscode_bytedance_parsing/val/image')
for img in img_list:
